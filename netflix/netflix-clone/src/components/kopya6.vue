<template>
  ...
  <div class="mainContainer">
    <div class="video-thumbnail-container" @mouseenter="isHovering = true" @mouseleave="isHovering = false">
        ...
        <video ref="videoPlayer" controls autoplay class="w-[100%] h-[95%] bottom-[100px]" loop>
        ...
        >
          ...
          <div class="swiper-container">
            ...
            <slot-comp
             ...
             class="swiper-wrapper" v-for="film in films">
              <button class="swiper-slide" @click="selectFilm(film)">
                <img class="resim" v-bind:src="film.url"/> <br />
                <video ref="videoPlayer"  controls autoplay class="w-[100%] h-[95%]" loop>
          ...
          <div class="swiper-container1">
            <slot-comp class="swiper-wrapper" v-for="film in films1">
              <button class="swiper-slide" @click="selectFilm(film)">
                <img class="resim" v-bind:src="film.url" /> <br />
                <video ref="videoPlayer"  controls autoplay class="w-[100%] h-[95%]" loop>
          <source :src="film.videoUrl" type="video/mp4" />
          ...
          <div class="swiper-container2">
            ...
            <slot-comp
             ...
             class="swiper-wrapper" v-for="film in films2">
              <button class="swiper-slide" @click="selectFilm(film)">
                <img class="resim" v-bind:src="film.url"/> <br />
                <video ref="videoPlayer"  controls autoplay class="w-[100%] h-[95%]" loop>
          <source :src="film.videoUrl" type="video/mp4" />
                ...
                <h4>{{ film.title }}</h4>
                <div class="c1" @click="selectFilm(film)">PLAY</div>
              </button>
            </slot-comp>
