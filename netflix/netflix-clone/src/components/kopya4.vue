<template>
  ...
  <div class="mainContainer">
    <div class="video-thumbnail-container" @mouseenter="isHovering = true" @mouseleave="isHovering = false">
        <img :src="selectedFilm.url" alt="Video Thumbnail" class="video-thumbnail" />
      ...
      <div class="button-container">
          ...
          <div class="buttons">
                        <button class="play-button" @click="togglePlay" > <i class="bi bi-play-fill" style="color: black; padding: 0%;"></i> Play Now </button>
